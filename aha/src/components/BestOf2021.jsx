  ...
  render() {
    ...
    return (
      <div >
        ...
        <Slider {...settings} >
          <div   className="cards">
            <Link to={"/movies/Lakshya"} style={{textDecoration: "none"}} > <img src="https://image-resizer-cloud-api.akamaized.net/image/082F82D4-9E62-4B95-AC33-97FA05F16989/0-2x3.jpg?width=181" alt="card1" />
          ...
          <div className="cards">
           <Link to={"/movies/Love_Story"} style={{textDecoration: "none"}} ><img src="https://image-resizer-cloud-api.akamaized.net/image/3B231226-EF16-442E-815E-AAEAF5108338/0-2x3.jpg?width=181" alt="card1" />
            <div className="premiumTag">
              <img src="https://www.aha.video/premium-tag.e5df97bbb026e5ce238e.svg" alt="premiumTag" />
            </div>
            <p>Love Story</p></Link>
          ...
          <div className="cards">
           <Link to={"/movies/Senapathi"} style={{textDecoration: "none"}} >
          ...
          <div className="cards">
            <Link to={"/movies/SR_KalyanaMandapam"} style={{textDecoration: "none"}} >
            ...
            <p>SR KalyanaMandapam</p></Link>
          </div>
          <div className="cards">
            <Link to={"/movies/Most_Eligible_Bachelor"} style={{textDecoration: "none"}} >
            ...
            <p>Most Eligible Bachelor</p></Link>
          </div>
          <div className="cards">
            <Link to={"/movies/Krack"} style={{textDecoration: "none"}} >
          ...
          <div className="cards">
            <Link to={"/movies/Jambie_Reddy"} style={{textDecoration: "none"}} >
            ...
            <p>Jambie Reddy</p></Link>
          </div>
          <div className="cards">
            <Link to={"/movies/Sulthan"} style={{textDecoration: "none"}} >
          ...
          <div className="cards">
            <Link to={"/movies/Pushapaka_Vimanam"} style={{textDecoration: "none"}} >
            ...
            <p>Pushapaka Vimanam</p></Link>
          </div>
          <div className="cards">
            <Link to={"/movies/Mail"} style={{textDecoration: "none"}} >
          ...
          <div className="cards">
            <Link to={"/movies/Superover"} style={{textDecoration: "none"}} >
          ...
          <div className="cards">
            <Link to={"/movies/Thank_You_Brother"} style={{textDecoration: "none"}} >
